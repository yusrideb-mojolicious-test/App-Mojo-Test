...
$t->get_ok('/')->status_is(200)
  ...
  # For Body Header
  ->element_exists('body header')->element_exists('body nav')
  ...
  ->attr_like(
  'body main[role=main] div.row div h3',
  class => qr/font-italic|border-bottom/)
  ...
  ->element_count_is(
  'body main[role=main] div.row div nav.blog-pagination' => 1)

  # For Body Sidebar
  ->element_exists('body main[role=main] div.row aside')
  ->attr_like('body main[role=main] div.row aside',
  class => qr/col-|blog|side|sidebar/)
  ->attr_unlike('body main[role=main] div.row aside',
  class => qr/co-|blg|sde|sidbar/)
  ->attr_like('body main[role=main] div.row aside h4', class => qr/font-italic/)
  ->attr_unlike('body main[role=main] div.row aside h4',
  class => qr/font-talic/)
  ...
  ->element_count_is('body footer p', 2)->element_count_is('body footer a', 3);
